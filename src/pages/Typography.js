        ...
        <>
            ...
            <div className='text-container'>
                ...
                <Section id='deconstructing-the-alphabet' >
                    ...
                    <Image className='left content-img' src='/assets/images/typography/ripped/1.jpg' />
                    ...
                    <Spacer h={30} />
                    <Image className='right content-img' src='/assets/images/typography/ripped/2.jpg' />
                    ...
                    <Spacer h={30} />
                    <Image className='left content-img' src='/assets/images/typography/ripped/3.png' />
                    ...
                    <Spacer h={20} />
                    <Image className='right content-img' src='/assets/images/typography/ripped/5.png' />
                ...
                <Section id='paul-thurlby' >
                    ...
                    <Image className='left content-img' src='/assets/images/typography/paul-thurlby/research/2.png' />
                    ...
                    <Spacer h={30} />
                    <Image className='right content-img' src='/assets/images/typography/paul-thurlby/research/1.jpeg' />
                    ...
                    <Image className='left content-img' src='/assets/images/typography/paul-thurlby/edited/image39.png' />
                    <p>For this letter, I started off by flipping the image, then rotating and scaling it, to fit the canvas. I then edited the vibrance of it, to make it stand out more, then added a hue saturation modifier to it, to change up the colours.</p>
                    <Spacer h={40} />
                    <Image className='right content-img' src='/assets/images/typography/paul-thurlby/edited/image40.png' />
                    <p>For this letter, I started off by adding a purple pattern in the background. I did this to try an emulate the grainy texture found on Thurlby’s Alphabet. I then used basic modifiers such as vibrance and contrast, to make it pop more.</p>
                    <Spacer h={40} />
                    <Image className='left content-img' src='/assets/images/typography/paul-thurlby/edited/image41.png' />
                    <p>For this letter, I started off I started off by adding a hue saturation layer, making it green. I then added a gradient map on top of it. I then edited the gradient map to give the effect you see.</p>
                    <Spacer h={40} />
                    <Image className='right content-img' src='/assets/images/typography/paul-thurlby/edited/image42.png' />
                    <p>For this letter, I added a gradient on top of it, and changed the opacity on it, adding an overlay to it. I then added a noise pattern, and changed the opacity to created a grainy effect, like in many of Thurlby’s Alphabet.</p>
                    <Spacer h={40} />
                    ...
                    <Image className='inline content-img' src='/assets/images/typography/paul-thurlby/processes/image45.png' />
                    <Image className='right content-img' src='/assets/images/typography/paul-thurlby/processes/image46.png' />
                    <Image className='left content-img' src='/assets/images/typography/paul-thurlby/processes/image47.png' />
                    <Spacer h={52} />
                </Section>
                <Section id='book-and-poster' >
                    ...
                    <Spacer h={16} />
                    <Image className='inline content-img' src='/assets/images/typography/book-poster/book-processes/image56.png' />
                    <Image className='right content-img' src='/assets/images/typography/book-poster/book-processes/image57.png' />
                    <Image className='inline content-img' src='/assets/images/typography/book-poster/book-processes/image58.png' />
                    <Image className='right content-img' src='/assets/images/typography/book-poster/book-processes/image59.png' />
